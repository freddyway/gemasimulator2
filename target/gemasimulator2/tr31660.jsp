...
<body>
  <div class="container">
	...
	<form action="${url}" method="post" class="cssform">
		...
		<table class="table table-bordered table-condensed">
			...
			<tr>
				...
				<td class="warning">ACTIVA</td>
				<td><input type="text" id="c02" name="c02" value="${respuesta.c02}" size="1" maxlength="1"></td>
			</tr>
			<tr>
			    <td><strong>C02</strong></td>
				<td class="warning">FECHA.CAD</td>
				<td><input type="text" id="c03" name="c03" value="${respuesta.c03}" size="6" maxlength="6"></td>
			</tr>
		</table>
		</c:if>
	</form>
	...
	<c:if test="${not empty respuesta.codRespuesta}">
		...
		<c:if test="${not empty respuesta.listTR31660}">
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<tbody>
						<c:forEach var="rows" items="${respuesta.listTR31660}">
							<tr>
