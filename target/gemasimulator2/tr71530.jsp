...
<body>
  <div class="container">
	...
	<h3>Alta de Cuenta de Domiciliacion desde Odin</h3>
	
	<c:url var="url0" value="/index.jsp" />
	<c:url var="url" value="/altacuentaodin" />
	...
	<form action="${url}" method="post" class="cssform">
		...
		<table class="table table-bordered table-condensed">
			...
			<tr>
				...
				<td class="warning">ESTADO-MIGRACION</td>
				<td><input type="text" id="c12" name="c12" value="${respuesta.c12}" size="1" maxlength="1"></td>
			</tr>
			<tr>
			    <td><strong>C12</strong></td>
				<td class="warning">FECHA-MIGRACION</td>
				<td><input type="text" id="c13" name="c13" value="${respuesta.c13}" size="8" maxlength="8"></td>
			</tr>
		</table>
		</c:if>
	</form>
	...
	<c:if test="${not empty respuesta.codRespuesta}">
		...
		<c:if test="${not empty respuesta.listTR71530}">
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<tbody>
						<c:forEach var="rows" items="${respuesta.listTR71530}">
							<tr>
