...
<body>
  <div class="container">
	...
	<h3>Modificacion de Cuenta de Domiciliacion</h3>
	
	<c:url var="url0" value="/index.jsp" />
	<c:url var="url" value="/modifcuenta" />
	...
	<c:if test="${not empty respuesta.codRespuesta}">
		...
		<c:if test="${not empty respuesta.listTR31532}">
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<tbody>
						<c:forEach var="rows" items="${respuesta.listTR31532}">
							<tr>
