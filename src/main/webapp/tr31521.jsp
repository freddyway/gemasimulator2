...
<body>
  <div class="container">
	...
	<h3>Consulta de Descuentos (31521)</h3>
	
	<c:url var="url0" value="/index.jsp" />
	<c:url var="url" value="/consuldtos" />
	...
	<c:if test="${not empty respuesta.codRespJPA}">
		...
		<c:if test="${not empty respuesta.listTR31521}">
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<tbody>
						<c:forEach var="rows" items="${respuesta.listTR31521}">
							<tr>
