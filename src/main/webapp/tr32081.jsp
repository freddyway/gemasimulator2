...
<body>
  <div class="container">
	...
	<h3>Modificacion Servicio DCC</h3>
	
	<c:url var="url0" value="/index.jsp" />
	<c:url var="url" value="/modifservdcc" />
	...
	<form action="${url}" method="post" class="cssform">
		...
		<table class="table table-bordered table-condensed">
			...
			<tr>
				...
				<td class="warning">NÚMERO-COMERCIO</td>
			...
			<tr>
				...
				<td class="warning">DCTO-PORCENTUAL-VISA-DCC</td>
	...
	<c:if test="${not empty respuesta.codRespuesta}">
		...
		<c:url var="url2" value="/modifservdcc?command=fila&rowid=" />
		<c:if test="${not empty respuesta.listTR32081}">
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-hover table-condensed">
					...
					<tbody>
						<c:forEach var="rows" items="${respuesta.listTR32081}">
							<tr>
