...
/**
 * The persistent class for the T31245 database table.
 * 
 */
@Entity
@Table(name="T01380")
@NamedQuery(name="T01380.findAll", query="SELECT t FROM T01380 t")
public class T01380 implements Serializable {
