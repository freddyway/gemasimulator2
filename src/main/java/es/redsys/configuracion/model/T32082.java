...
/**
 * The persistent class for the T32082 database table.
 * 
 */
@Entity
@Table(name="T32082")
@NamedQuery(name="T32082.findAll", query="SELECT t FROM T32082 t")
public class T32082 implements Serializable {
