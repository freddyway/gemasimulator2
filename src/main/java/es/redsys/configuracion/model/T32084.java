...
/**
 * The persistent class for the T32084 database table.
 * 
 */
@Entity
@Table(name="T32084")
@NamedQuery(name="T32084.findAll", query="SELECT t FROM T32084 t")
public class T32084 implements Serializable {
