...
/**
 * The persistent class for the T31521 database table.
 * 
 */
@Entity
@Table(name="T31521")
@NamedQuery(name="T31521.findAll", query="SELECT t FROM T31521 t")
public class T31521 implements Serializable {
