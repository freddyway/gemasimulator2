...
/**
 * The persistent class for the T32081 database table.
 * 
 */
@Entity
@Table(name="T32081")
@NamedQuery(name="T32081.findAll", query="SELECT t FROM T32081 t")
public class T32081 implements Serializable {
