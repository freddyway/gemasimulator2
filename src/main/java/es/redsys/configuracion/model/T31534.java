...
/**
 * The persistent class for the T31534 database table.
 * 
 */
@Entity
@Table(name="T31534")
@NamedQuery(name="T31534.findAll", query="SELECT t FROM T31534 t")
public class T31534 implements Serializable {
